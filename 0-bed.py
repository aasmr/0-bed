...
class Body():
    ...
    def get_rest(self, name, req_count):
        ...
        while (3 in counter_win) != True: #пока среди счетчиков побед нет хотя бы одной тройки
            ...
            counter_win[name.index(lot_dict[rand[0]])]+=1 #смотрим какое заведение соответствует рандомной цифре, смотрим индекс этого заведения в списке названий и по этому индксу увеличиваем счетчик побед
